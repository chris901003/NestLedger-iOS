...
class LedgerDetailViewController: UIViewController {
    ...
    @objc private func tapAddTransaction() {
        ...
        let transactionViewController = TransactionViewController(.init(ledgerId: ledgerId, initialDate: manager.selectedDate))
...
extension LedgerDetailViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        Task {
            guard let avatar = await CacheUserAvatarManager.shared.getUserAvatar(userId: userData.id) else { return }
